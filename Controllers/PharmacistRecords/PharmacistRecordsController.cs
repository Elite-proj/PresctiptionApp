    ...
    public class PharmacistRecordsController : Controller
    {
        ...
        public IActionResult List()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                pharmacist.ContactNo = dt.Rows[i]["ContactNo"].ToString();
                ...
                pharmacist.RegNumber = dt.Rows[i]["RegNumber"].ToString();
        ...
        public IActionResult Edit(int id)
        {
            ...
            if(dt.Rows.Count>0)
            {
                ...
                pharmacist.ContactNo = dt.Rows[0]["ContactNo"].ToString();
                pharmacist.PostalCode = dt.Rows[0]["PostalCode"].ToString();
                ...
                pharmacist.CityID= int.Parse(dt.Rows[0]["CityID"].ToString());
                pharmacist.ProvinceID= int.Parse(dt.Rows[0]["ProvinceID"].ToString());
                ...
                pharmacist.RegNumber = dt.Rows[0]["RegNumber"].ToString();
                pharmacist.PharmacyID = int.Parse(dt.Rows[0]["PharmacyID"].ToString());
                pharmacist.PharmacistId= int.Parse(dt.Rows[0]["PharmacistID"].ToString());
            }
            

            LoadSuburbs(pharmacist.CityID);
            //Get pharmacy By ID
            pharmacyDt = data.GetPharmacyRecords();
        ...
        [HttpPost]
        public IActionResult Edit(PharmacistAccount pharmacistAccount)
        {
            if(ModelState.IsValid)
            {
                data = new DataAccess(configuration);
                data.UpdatePharmacist(pharmacistAccount);

                TempData["PharmacistEdit"] = $"Successfully updated pharmacist records.";
