        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicationRecord_DosageForm",
                        column: x => x.DosageID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostalCodeName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CityID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "Medication_ActiveIngredient",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Medication_ActiveIngredient", x => x.MedicationIngredientID);
                    table.ForeignKey(
                        name: "FK_Medication_ActiveIngredient_ActiveIngredient",
                        column: x => x.IngredientID,
                        principalTable: "ActiveIngredient",
                        principalColumn: "IngredientID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Medication_ActiveIngredient_MedicationRecord",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalPractice_Province",
                        column: x => x.ProvinceID,
                        principalTable: "Province",
                        principalColumn: "ProvinceID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalPractice_Suburb",
                        column: x => x.SuburbID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalPractice_ProvinceID",
                table: "MedicalPractice",
                column: "ProvinceID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medication_ActiveIngredient_IngredientID",
                table: "Medication_ActiveIngredient",
                column: "IngredientID");

            migrationBuilder.CreateIndex(
                name: "IX_Medication_ActiveIngredient_MedicationID",
                table: "Medication_ActiveIngredient",
                column: "MedicationID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicationRecord_DosageID",
